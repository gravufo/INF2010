...
public class FormValidator
{
      ...
      /**
       * Genere et retourne un string de longueur length avec des caracteres
       * aleatoires
       * choisis entre A et Z
       *
       * @param length : longueur de la chaine de caractere a generer (inferieur
       *               ou egal a 10)
       */
      private static String generateCode(int length)
      {
	    ...
	    String retour = ""; // Variable qui contiendra les lettres generees
	    ...
	    {
		  // Rajout de la nouvelle lettre generee aleatoirement
       ...
       *
       * @param nb : longueur de la chaine de caractere a generer (inferieur ou
       *           egal a 10)
       */
      private static int[] generateTransform(int nb)
      {
	    ...
	    for (int i = 0; i < nb; i++)
	    {
		  // Rajout d'un nombre aleatoire entre 1 et 5 dans le tableau
